...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |   ~  |   !  |   @  |   #  |   $  |   %  |             |   ^  |   &  |  Up  |   {  |   }  |  |   |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |      |  F1  |  F2  |  F3  |  F4  |  F5  |             |  F6  | Left | Down |Right |   _  |   +  |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
  ...
  [_LOWER] = LAYOUT( \
      ...
      KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, _______, KC_UP,    KC_LCBR,     KC_RCBR,   KC_PIPE, \
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_LEFT, KC_DOWN,  KC_RGHT,     KC_UNDS,   KC_PLUS, \
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_LPRN, KC_RPRN, KC_F12,  KC_HOME, _______,  KC_END,      _______,   _______, \
